...
| BCM GPIO Number | gpiod Line Offset |
| --------------- | ----------------- |
| 4               | 516               |
| 16              | 528               |
| 17              | 529               |
...
When programming, we must use the gpiod line offsets. While the tests included use the gpiod numbers already, you may need to refer to this table when writing your own code.
